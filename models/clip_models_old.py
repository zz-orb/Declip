...
class CLIPModelLocalisation(nn.Module):
    def __init__(self, name, intermidiate_layer_output = None, decoder_type = "conv-4", use_noise_view = False, use_aspp = False, use_conprn = False, use_simdet = False):
    ...
    def _set_backbone(self):    
        ...
        # ViT+RN fusion
            ...
            model_path = '/nas/datasets/Basemodel/GeoRSCLIP/ckpt/RS5M_ViT-L-14.pt'
